...
var Student = function (_Person2) {
  _inherits(Student, _Person2);

  function Student(name, age, major) {
    _classCallCheck(this, Student);

    var _this2 = _possibleConstructorReturn(this, (Student.__proto__ || Object.getPrototypeOf(Student)).call(this, name, age));
...
var me = new Student("Edgar", 44, "Comp Scien");
var ted = new Traveler("Ted", 22, "New York");
